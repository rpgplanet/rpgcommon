...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('user_facebookaccount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('facebook_uid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
            ('access_token', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('expires', self.gf('django.db.models.fields.DateTimeField')()),
            ('secret', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
        ...
        db.send_create_signal('user', ['FacebookAccount'])


    def backwards(self, orm):
        
        # Deleting model 'FacebookAccount'
        db.delete_table('user_facebookaccount')
